...
export class AnalysisType {
  ...
  private createTemporaryConfigFile(timestamp: number): string {
    ...
    const tempDirectory = dirname(
      join(AnalysisType.CONFIG_DIRECTORY, this._configFile.template)
    );
